...
kubectl run my-first-pod --image radhey24h/user:1.1
```  
...
# Create  a Pod
kubectl run <desired-pod-name> --image <Container-Image> 
kubectl run user --image radhey24h/user:1.0 

# Expose Pod as a Service
kubectl expose pod <Pod-Name>  --type=LoadBalancer --port=80 --name=<Service-Name>
kubectl expose pod user  --type=LoadBalancer --port=80 --name=user
